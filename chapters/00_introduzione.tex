...
Questi, se opportunamente interpretati da sistemi informatici, possono rivelare le logiche molecolari alla base di processi come cicli metabolici e la cura di malattie.
...
A sottolineare l'importanza del dialogo tra discipline di ricerca scientifica e tecniche computazionali, è importante menzionare che AlphaFold rappresenta uno dei primi premi Nobel assegnati ad un'applicazione di carattere informatico, ambito per il quale l'onoreficenza non prevede una categoria.
...
dimostrano come il ML applicato alla bioinformatica, e in più particolare alla drug discovery, sia già una realtà operativa.
