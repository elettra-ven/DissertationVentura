...
laboratorio, concentrando le risorse sui candidati più promettenti, invece di limitarsi a eliminare l'incertezza dei dati biologici.\\
...
In particolare le architetture di tipo \textbf{ibrido} (come TC-DTA) si dimostrano ideali per fornire un buon compromesso tra l'efficienza di predizione e l'accuratezza della rappresentazione. Infatti, queste combinazioni permettono di separare l'elaborazione computazionale del farmaco da quella del target, fornendo rappresentazioni diverse e ottimizzando la raccolta delle informazioni (per esempio, le CNN colgono pattern locali su sequenze brevi come le SMILES, mentre i Transformer catturano le dipendenze a lungo raggio necessarie per le sequenze proteiche, ben più estese).\\
