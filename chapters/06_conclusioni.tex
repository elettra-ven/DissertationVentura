...
l'ostacolo di traduzione delle entità biochimiche in formati leggibili ed elaborabili dagli algoritmi sia stato 
...
Questo sbilanciamento porta i modelli a essere eccessivamente ottimisti nelle predizioni (che tendono a seguire la classe maggioritaria) e a fallire nell'identificazione di interazioni rare ma biologicamente significative.
