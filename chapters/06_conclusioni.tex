...
laboratorio, concentrando le risorse sui candidati più promettenti, invece che limitarsi a eliminare l'incertezza dei dati biologici.
...
In particolare le architetture di tipo \textbf{ibrido} (come TC-DTA) si dimostrano ideali per fornire un buon compromesso tra l'efficienza di predizione e l'accuratezza della rappresentazione. Infatti, la multimodalità permette di separare l'elaborazione computazionale del farmaco da quella del target, fornendo rappresentazioni diverse e ottimizzando la raccolta delle informazioni (per esempio, le CNN colgono pattern locali su sequenze brevi come le SMILES, mentre i Transformer catturano le dipendenze a lungo raggio necessarie per le sequenze proteiche, ben più estese).
...
&
Costo computazionale del message passing alto. Necessita di feature engineering sui nodi/archi \\
\hline
Transformer / PLM &
Cattura dipendenze a lungo raggio. Interpretabile tramite mappe di attenzione.
Robustezza in scenari Cold-Start
&
